...
console.log('task1 old', task1Old(10) === 500);
console.log('task1 new', task1New(10) === 500);
...
console.log('task10 old', task11Old({ a: 0 }, 'a'), 'task10 new', task11New({ a: 0 }, 'a')); // - > 0
console.log('task10 old', task11Old({ a: 1 }, 'a'), 'task10 new', task11New({ a: 1 }, 'a')); // -> 1
console.log('task10 old', task11Old({ a: null }, 'a'), 'task10 new', task11New({ a: null }, 'a')); // -> false
console.log('task10 old', task11Old({}, 'a'), 'task10 new', task11New({}, 'a')); // -> false
console.log('task10 old', task11Old({ a: '' }, 'a'), 'task10 new', task11New({ a: '' }, 'a')); // -> ''
...
console.log('task15 old', task15Old([
    ['a', 1],
    ['b', 2]
])); // {a: 1, b: 2}
console.log('task15 new', task15New([
    ['a', 1],
    ['b', 2]
])); // {a: 1, b: 2}
